import { GameOptions } from 'src/app/contracts/model/TournamentOptions';
import { Person } from 'src/app/contracts/model/Person';

export class SetTournamentName {
    static readonly type = '[OPTIONS] SetTournamentName';
...
export class CreateTournament {
    static readonly type = '[OPTIONS] CreateTournament';
    constructor() {}
}
